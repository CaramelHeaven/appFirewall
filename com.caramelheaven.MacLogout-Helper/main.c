...
//		i.e. com.caramelheaven.MacLogout-Helper
...
//    pointing to this helper app com.caramelheaven.MacLogout-Helper
// 4. And the secret/non-documented step:  add the following linker options to
//	 	com.caramelheaven.MacLogout-Helper:
//		-sectcreate __TEXT __info_plist com.caramelheaven.MacLogout-Helper/Info.plist
//		-sectcreate __TEXT __launchd_plist com.caramelheaven.MacLogout-Helper/launchd.plist
//		which embed the plist files into the com.caramelheaven.MacLogout-Helper executable
// 5. Last step: main appFirewall app must copy com.caramelheaven.MacLogout-Helper executable
...
#define LOGFILE "/Library/Logs/MacLogout-Helper.log"
#define ROTFILE "/etc/newsyslog.d/MacLogout-Helper.conf"
#define PIDFILE "/var/run/com.caramelheaven.MacLogout-Helper.pid"
// compile with gcc -g -lpcap -lnet pcap_sniffer.c dtrace.c util.c send_rst.c main.c
// debug with lldb:
// sudo lldb ./com.caramelheaven.MacLogout-Helper
